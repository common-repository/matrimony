...
if( isset( $_POST['profile_id'] ) ) {
	$user_id 			  = sanitize_text_field( $_POST['profile_id'] );
	$table_name 		  = $wpdb->prefix . "matri_bio";
	$table_name2  		  = $wpdb->prefix . "height";
	$single_profile 	  = $wpdb->get_results( $wpdb->prepare( "SELECT `$table_name`.*, `$table_name2`.* FROM `$table_name` INNER JOIN `$table_name2` ON `$table_name2`.`heightId`=`$table_name`.`height` WHERE `$table_name`.`id` = %d",$user_id ));
				...
				<ul class="nav nav-tabs" id="myTab" role="tablist">			  
				  <li class="nav-item">
				    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">
						<?php _e( 'Family Detail', MWA_MATRI_SYSTEM ); ?>
					</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">
						<?php _e( 'Personal Detail', MWA_MATRI_SYSTEM ); ?>
					</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">
						<?php _e( 'Other Detail', MWA_MATRI_SYSTEM ); ?>
					</a>
				  </li>
				</ul>
				  	...
				  	<div class="row">
				  		<div class="col">
					  		<table class="table table-responsive table-striped table-bordered">
						  		<tr>
						  			<th>
									<?php _e( 'Name', MWA_MATRI_SYSTEM ); ?>
									</th>
						  			<td>
									<?php echo ucwords( $candidate_name ); ?>
									</td>
						  		</tr>
						  		<tr>
				  		...
				  		<div class="col">
				  			<table class="table table-responsive table-striped table-bordered">
				  				...
				  				<tr>
				  					...
				  					<td><?php echo $mwa_extra_info; echo $profile_image_url; ?></td>
				  				</tr>
				  			</table>
				  		</div>			  		
				  			<?php echo $profile_image_url; ?>			  			
